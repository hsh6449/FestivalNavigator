  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg bg-gray-50 p-6">
        <h3 className="mb-4 text-lg font-semibold text-gray-900">공연 일정</h3>
        <div className="space-y-2 text-gray-600">
          ...
          <div className="flex items-center">
            ...
            {isFestival ? (
              <span>상세 시간은 타임테이블 탭 또는 공식 공지를 기준으로 확인</span>
            ) : (
              <span>
      ...
      <section className="rounded-lg bg-gray-50 p-6">
        <h3 className="mb-4 text-lg font-semibold text-gray-900">공연장 정보</h3>
        <div className="space-y-2 text-gray-600">
          <div className="flex items-center">
            <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
        ...
        <div className="mt-6 border-t border-gray-200 pt-6">
          <h4 className="mb-3 text-base font-semibold text-gray-900">공연장 위치</h4>
          <VenueMap
            title={event.title}
            venue={event.venue}
      ...
      <section className="rounded-lg bg-gray-50 p-6">
        <h3 className="mb-4 text-lg font-semibold text-gray-900">티켓 정보</h3>
        <div className="space-y-2 text-gray-600">
